...
def profile(x_n, y_n, x_obs, y_obs, best):
    ...
    plt.savefig("Figs/FigS1b/Profiles.pdf")
    ...
    plt.savefig("Figs/FigS1b/Profile_median_percentiles.pdf")
...
def sealevel(xsl, ysl, best):
    ...
    cbar.set_label("Probability", fontsize=fs - 4)
    ax.legend(loc=4)
    plt.savefig("Figs/FigS1b/Sea-Level.pdf")
    ...
    plt.savefig("Figs/FigS1b/Sea-Level_median_percentiles.pdf")
