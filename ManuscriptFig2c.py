...
x_obs, y_obs = tools.readfile("../reef/examples/TopoObs_Fig2c.dat")
...
fig.savefig("Figs/Fig2c/Stats-Loglikelihood.pdf", format="pdf", bbox_inches="tight")

fig=plt.figure()
plt.plot(chain.stats["prop_S"][1:])
# fig.savefig('Figs/Stats-prop_S.png')
fig.savefig("Figs/Fig2c/Stats-prop_S.pdf", format="pdf", bbox_inches="tight")

fig=plt.figure()
plt.plot(chain.stats["accept_ratio"][1:])
# fig.savefig('Figs/Stats-accept_ratio.png')
fig.savefig("Figs/Fig2c/Stats-accept_ratio.pdf", format="pdf", bbox_inches="tight")

fig=plt.figure()
plt.plot(chain.stats["parameter_accept_ratio"][1:])
# fig.savefig('Figs/Stats-parameter_accept_ratio.png')
fig.savefig("Figs/Fig2c/Stats-parameter_accept_ratio.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2c/Histogram-2D-1.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2c/Histogram-2D-2.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2c/Histogram-2D-3.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2c/Histogram-2D-4.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2c/Histogram-2D-5.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2c/Histogram-2D-6.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2c/Histogram-2D-7.pdf", format="pdf", bbox_inches="tight")
