...
def profile(x_n, y_n, x_obs, y_obs, best):
    ...
    # plt.savefig("Figs/Fig2a_Vert/Profiles.pdf", format="pdf", bbox_inches="tight")
    ...
    plt.savefig("Figs/Fig2a_Vert/Profile_median_percentiles.pdf", format="pdf", bbox_inches="tight")
...
def sealevel(xsl, ysl, best):
    ...
    fig = plt.figure()
    ax = plt.gca()
    plt.pcolormesh((-X) + 79, Y, hist, cmap='viridis', vmin=0.0, vmax=0.1)
    ...
    cbar.set_label("Probability", fontsize=fs - 4)
    ax.legend(loc=4)
    plt.savefig("Figs/Fig2a_Vert/Sea-Level.pdf", format="pdf", bbox_inches="tight")
    ...
    plt.savefig("Figs/Fig2a_Vert/Sea-Level_median_percentiles.pdf", format="pdf", bbox_inches="tight")
