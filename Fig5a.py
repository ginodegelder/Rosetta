...
def profile(x_n, y_n, x_obs, y_obs, best):
    ...
    ax.legend(loc=4)
    plt.savefig("Figs/FigS4a/Profiles.pdf")
    ...
    plt.savefig("Figs/FigS4a/Profile_median_percentiles.pdf")

    best_prof = x_n[best, :]
    np.savetxt("Figs/FigS4a/MeanProfile.txt", mean)
    np.savetxt("Figs/FigS4a/MedianProfile.txt", p50)
    np.savetxt("Figs/FigS4a/BestProfile.txt", best_prof)
...
def sealevel(xsl, ysl, best):
    ...
    cbar.set_label("Probability", fontsize=fs - 4)
    ax.legend(loc=4)
    plt.savefig("Figs/FigS4a/Sea-Level.pdf")
    ...
    plt.savefig("Figs/FigS4a/Sea-Level_median_percentiles.pdf")
