...
def profile(x_n, y_n, x_obs, y_obs, best, i):
    ...
    ax.legend(loc=4)
    plt.savefig("Figs/FigS4d/Profiles_{}.pdf".format(i))
    ...
    plt.savefig("Figs/FigS4d/Profile_median_percentiles_{}.pdf".format(i))

    best_prof = x_n[best, :]
    np.savetxt("Figs/FigS4d/MeanProfile_{}.txt".format(i), mean)
    np.savetxt("Figs/FigS4d/MedianProfile_{}.txt".format(i), p50)
    np.savetxt("Figs/FigS4d/BestProfile_{}.txt".format(i), best_prof)
...
def sealevel(xsl, ysl, best):
    ...
    plt.plot((-xsl) + 449, mean, '--r', label="Mean")
    ...
    cbar.set_label("Probability", fontsize=fs - 4)
    ax.legend(loc=4)
    plt.savefig("Figs/FigS4d/Sea-Level.pdf")
    ...
    plt.savefig("Figs/FigS4d/Sea-Level_median_percentiles.pdf")
