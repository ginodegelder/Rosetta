...
def profile(x_n, y_n, x_obs, y_obs, best):
    ...
    plt.savefig("Figs/Fig2c/Profiles.pdf")
    ...
    plt.savefig("Figs/Fig2c/Profile_median_percentiles.pdf")
...
def sealevel(xsl, ysl, best):
    ...
    plt.savefig("Figs/Fig2c/Sea-Level.pdf")
    ...
    plt.savefig("Figs/Fig2c/Sea-Level_median_percentiles.pdf")
