...
def profile(x_n, y_n, x_obs, y_obs, best, i):
    #x_obs = x_obs - x_obs[0]
    off = x_n[0, 0]
    # x_n = x_n[stp:]
    # y_n = y_n[stp:]
    ...
    plt.plot(x_obs[i], y_obs[i], 'k', label='Observed Topo')
    ...
    ax.legend(loc=4)
    # plt.savefig("Figs/Profiles_{}.png".format(i), dpi=300)
    plt.savefig("Figs/Fig2d/Profiles_{}.pdf".format(i))
    ...
    # plt.savefig("Figs/Profile_median_percentiles_{}.png".format(i), dpi=300, facecolor=fig.get_facecolor(), edgecolor='none')
    plt.savefig("Figs/Fig2d/Profile_median_percentiles_{}.pdf".format(i))
...
def sealevel(xsl, ysl, best):
    ...
    plt.plot((-xsl) + 152, p50, '-r', label="Median")
    plt.plot((-xsl) + 152, p025, '--r')
    plt.plot((-xsl) + 152, p975, '--r')
    ...
    plt.savefig("Figs/Fig2d/Sea-Level.pdf")
    ...
    plt.savefig("Figs/Fig2d/Sea-Level_median_percentiles.pdf")
