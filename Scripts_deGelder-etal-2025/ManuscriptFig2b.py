...
from ScriptsFigs_deGelder_etal_2025 import Fig2b as Fig2b
...
x_obs, y_obs = tools.readfile("../Topo_obs/TopoObs_Fig2b.dat")
...
fig.savefig("Figs/Fig2b/Stats-Loglikelihood.pdf", format="pdf", bbox_inches="tight")

fig=plt.figure()
plt.plot(chain.stats["prop_S"][1:])
# fig.savefig('Figs/Stats-prop_S.png')
fig.savefig("Figs/Fig2b/Stats-prop_S.pdf", format="pdf", bbox_inches="tight")

fig=plt.figure()
plt.plot(chain.stats["accept_ratio"][1:])
# fig.savefig('Figs/Stats-accept_ratio.png')
fig.savefig("Figs/Fig2b/Stats-accept_ratio.pdf", format="pdf", bbox_inches="tight")

fig=plt.figure()
plt.plot(chain.stats["parameter_accept_ratio"][1:])
# fig.savefig('Figs/Stats-parameter_accept_ratio.png')
fig.savefig("Figs/Fig2b/Stats-parameter_accept_ratio.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2b/Histogram-2D-1.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2b/Histogram-2D-2.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2b/Histogram-2D-3.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2b/Histogram-2D-4.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2b/Histogram-2D-5.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2b/Histogram-2D-6.pdf", format="pdf", bbox_inches="tight")
...
fig.savefig("Figs/Fig2b/Histogram-2D-7.pdf", format="pdf", bbox_inches="tight")
